...
<div class="py-32 text-center md:mt-44 lg:mt-10"  >
  <h2 class="font-extrabold text-6xl mb-2 text-white ">Discover Your New Home</h2>
...
<div class="flex justify-center">
  <div class="w-8/12 bg-white p-3 rounded-lg flex items-center ">
    ...
    <input type="text" placeholder="Search.." class="w-full bg-white p-6 rounded-lg text-2xl">
  </div>
